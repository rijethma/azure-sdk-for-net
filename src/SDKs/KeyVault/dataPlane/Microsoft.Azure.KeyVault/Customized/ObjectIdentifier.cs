...
namespace Microsoft.Azure.KeyVault
{
    ...
    /// <summary>
    /// The Key Vault storage identifier.
    /// </summary>
    public sealed class StorageAccountIdentifier : ObjectIdentifier
    {
        ...
        /// Constructor.
        /// </summary>
        /// <param name="identifier">The identifier for storage account.</param>
    ...
    public sealed class SasDefinitionIdentifier : ObjectIdentifier
    {
        ...
        public SasDefinitionIdentifier(string vaultBaseUrl, string storageAccountName, string sasDefNname)
        {
            if (string.IsNullOrEmpty(vaultBaseUrl))
