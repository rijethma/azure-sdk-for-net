...
namespace Microsoft.Azure.KeyVault
{
    ...
    {
        /// <summary>
        /// Verifies whether the identifier belongs to a key vault storage accounts.
        /// </summary>
        /// <param name="identifier">The key vault storage account identifier.</param>
        /// <returns>True if the identifier belongs to a key vault storage accounts. False otherwise.</returns>
        ...
        /// Constructor.
        /// </summary>
        /// <param name="identifier">The identifier for storage accounts.</param>
    ...
    public sealed class SasDefinitionIdentifier : ObjectIdentifier
    {
        ...
        /// </summary>
        /// <param name="vaultBaseUrl"> the vault base URL</param>
        /// <param name="strgName">the name of the storage account.</param>
        /// <param name="sasDefNname">the name of the storage sas definition.</param>
        public SasDefinitionIdentifier(string vaultBaseUrl, string strgName, string sasDefNname)
        {
            if (string.IsNullOrEmpty(vaultBaseUrl))
                throw new ArgumentNullException(nameof(vaultBaseUrl));

            if (string.IsNullOrEmpty(strgName))
                throw new ArgumentNullException(nameof(strgName));

            if (string.IsNullOrEmpty(sasDefNname))
                throw new ArgumentNullException(nameof(sasDefNname));

            var baseUri = new Uri(vaultBaseUrl, UriKind.Absolute);

            StorageAccount = strgName;
            Name = sasDefNname;
            Version = string.Empty;
            Vault = string.Format(CultureInfo.InvariantCulture, "{0}://{1}", baseUri.Scheme, baseUri.FullAuthority());
            VaultWithoutScheme = baseUri.Authority;
        ...
        /// Constructor.
        /// </summary>
        /// <param name="identifier">The identifier for storage sas definition.</param>
